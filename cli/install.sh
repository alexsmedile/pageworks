...
GITHUB_REPO="alexsmedile/pageworks"
INSTALL_DIR="${HOME}/.local/bin"
BINARY_NAME="pageworks"
SCRIPT_URL="https://raw.githubusercontent.com/${GITHUB_REPO}/main/cli/pageworks"
...
main() {
  ...
  check_path
  info ""
  info "Done. Run 'pageworks init' inside any project to get started."
}
